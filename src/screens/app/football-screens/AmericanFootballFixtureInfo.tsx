...
export const AmericanFootballFixtureInfo = ({
  navigation,
  route,
}: RootStackScreenProps<appScreenNames.AMERICAN_FOOTBALL_FIXTURE_INFO>) => {
  ...
  const getOverViewData = () => {
    const filteredData = americanFootballFixtures.find((f) => f.id === id);
        ...
        <ScrollContainer>
          <Animated.View entering={FadeIn.delay(200).duration(600)}>
            <OverviewTab
              ...
              fixtureId={id}
              fixtureData={americanFootballFixtures}
            />
          </Animated.View>
          <View
            style={{
