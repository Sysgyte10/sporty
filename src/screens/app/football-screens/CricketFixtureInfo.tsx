...
export const CricketFixtureInfo = ({
  navigation,
  route,
}: RootStackScreenProps<appScreenNames.CRICKET_FIXTURE_INFO>) => {
  ...
  const getOverViewData = () => {
    const filteredData = cricketFixtures.find((f) => f.id === id);
