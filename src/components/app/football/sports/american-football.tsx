...
import { americanFootballFixtures } from "@src/constants/fixtures";
import { moderateScale } from "@src/resources/responsiveness";
import React from "react";
import { FlatList, ImageSourcePropType, View } from "react-native";

interface IAmericanFootballProps {
  onPress: (
    id: any,
...
export const AmericanFootballSport: React.FC<IAmericanFootballProps> = ({
  onPress,
  onPressMatchCard,
}) => {
  return (
